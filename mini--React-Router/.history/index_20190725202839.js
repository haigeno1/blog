...
const Xxx = ({
  match
}) => React.createElement("div", null, match.params.id);

const NotFound = () => React.createElement("div", null, "NotFound");

class HelloWorld extends Component {
  render() {
    return React.createElement("div", null, React.createElement("ul", null, React.createElement("li", null, React.createElement(Link, {
      to: "/"
    }, "Home")), React.createElement("li", null, React.createElement(Link, {
      to: "/about"
    }, "about")), React.createElement("li", null, React.createElement(Link, {
      to: "/xxx/12"
    }, "xxx"))), React.createElement("hr", null), React.createElement(Route, {
      path: "/",
      exact: true,
